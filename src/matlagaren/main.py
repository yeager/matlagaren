...
class MainWindow(Adw.ApplicationWindow):
    def __init__(self, **kwargs):
        ...
        self.set_title(_('Cooking Guide'))
        ...
        app_btn = Gtk.Button()
        app_btn.set_icon_name("se.danielnylander.matlagaren")
        app_btn.add_css_class("flat")
        app_btn.set_tooltip_text(_("Matlagaren"))
...
class App(Adw.Application):
    def __init__(self):
        ...
        about.connect('activate', lambda a,p: Adw.AboutDialog(application_name=_('Cooking Guide'),
